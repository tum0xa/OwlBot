...
/batch_sticker_start - Начать процесс приема стикеров "пачкой" для последующего сохранения

/batch_sticker_end - закончить процесс приема стикеров "пачкой" и принять результат
